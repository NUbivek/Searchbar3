const handler = require('../../../src/pages/api/relay/linkedin').default;
...
describe('/api/relay/linkedin', () => {
  ...
  it('renders the linkedin relay page with the callback parameters', () => {
    const req = {
      method: 'GET',
      query: {
        code: 'abc1234567890',
    ...
    expect(res.body).toContain('LinkedIn OAuth Relay');
  ...
  it('renders the oauth error state when linkedin returns an error', () => {
    const req = {
      method: 'GET',
      query: {
        error: 'access_denied',

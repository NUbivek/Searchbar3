...
describe('sourcing adapters', () => {
  ...
  test('HtmlListAdapter extracts Operator Insights-style portfolio entries', async () => {
    global.fetch = jest.fn().mockResolvedValue({
      ok: true,
      text: async () => `
        <html>
          <body>
            <div class="portfolio-item">
              <a class="internal-link" href="/portfolio/signalsops">View</a>
              <div class="company-name">SignalsOps</div>
              <div class="description">Operator analytics software for workflow signaling, execution monitoring, and systems visibility.</div>
              <div class="subtext">US startup helping finance, support, and GTM teams monitor approvals, routing, and launch execution.</div>
              <div class="company-site"><a href="https://signalsops.io/">Website</a></div>
            </div>
            <div class="footer-cta">
              <a href="/portfolio/footer-link">Ignore</a>
            </div>
    ...
    const adapter = new HtmlListAdapter({
      method: {
        url: 'https://operatorinsights.vc/portfolio',
        extract: {
          itemSelector: ['.portfolio-item', '.portfolio-card'],
          linkSelector: ['a[href*="/portfolio/"]', 'a[href]'],
          titleSelector: ['.company-name', 'h2'],
          ...
          companyNameSelector: ['.company-name', 'h2'],
          companyWebsiteSelector: [
            'a[href*="http"]:not([href*="operatorinsights.vc"])',
            '.company-site a[href]',
          ],
          includePatterns: ['/portfolio/'],
          excludeSelectors: ['.footer-cta', '.cta-banner'],
    ...
    expect(results).toHaveLength(1);
    expect(results[0].title).toBe('SignalsOps');
    expect(results[0].content).toBe('US startup helping finance, support, and GTM teams monitor approvals, routing, and launch execution. | Operator analytics software for workflow signaling, execution monitoring, and systems visibility.');
    expect(results[0].company_name).toBe('SignalsOps');
    expect(results[0].company_website).toBe('https://signalsops.io/');
    expect(results[0].url).toBe('https://operatorinsights.vc/portfolio/signalsops');
  });

  test('HtmlListAdapter extracts Operator Vision-style portfolio entries', async () => {
    global.fetch = jest.fn().mockResolvedValue({
      ok: true,
      text: async () => `
        <html>
          <body>
            <div class="portfolio-item">
              <a class="internal-link" href="/portfolio/visionops">View</a>
              <div class="company-name">VisionOps</div>
              <div class="description">Operator intelligence software for workflow visibility, execution coordination, and systemized monitoring.</div>
              <div class="subtext">US startup helping finance, support, and GTM teams monitor routing, approvals, and launch execution.</div>
              <div class="company-site"><a href="https://visionops.io/">Website</a></div>
            </div>
            <div class="footer-cta">
              <a href="/portfolio/footer-link">Ignore</a>
            </div>
    ...
    const adapter = new HtmlListAdapter({
      method: {
        url: 'https://operatorvision.vc/portfolio',
        extract: {
          itemSelector: ['.portfolio-item', '.portfolio-card'],
          linkSelector: ['a[href*="/portfolio/"]', 'a[href]'],
          titleSelector: ['.company-name', 'h2'],
          ...
          companyNameSelector: ['.company-name', 'h2'],
          companyWebsiteSelector: [
            'a[href*="http"]:not([href*="operatorvision.vc"])',
            '.company-site a[href]',
          ],
          includePatterns: ['/portfolio/'],
          excludeSelectors: ['.footer-cta', '.cta-banner'],
    ...
    expect(results).toHaveLength(1);
    expect(results[0].title).toBe('VisionOps');
    expect(results[0].content).toBe('US startup helping finance, support, and GTM teams monitor routing, approvals, and launch execution. | Operator intelligence software for workflow visibility, execution coordination, and systemized monitoring.');
    expect(results[0].company_name).toBe('VisionOps');
    expect(results[0].company_website).toBe('https://visionops.io/');
  ...
  test('HtmlListAdapter extracts Operator Scope-style portfolio entries', async () => {
    global.fetch = jest.fn().mockResolvedValue({
      ok: true,
      text: async () => `
        <html>
          <body>
            <div class="portfolio-item">
              <a class="internal-link" href="/portfolio/scopeops">View</a>
              <div class="company-name">ScopeOps</div>
              <div class="description">Operator intelligence software for workflow analytics, execution monitoring, and operating visibility.</div>
              <div class="subtext">US startup helping finance, support, and GTM teams monitor routing, approvals, and launches with stronger operational scope.</div>
              <div class="company-site"><a href="https://scopeops.io/">Website</a></div>
            </div>
            <div class="footer-cta">
              <a href="/portfolio/footer-link">Ignore</a>
            </div>
    ...
    const adapter = new HtmlListAdapter({
      method: {
        url: 'https://operatorscope.vc/portfolio',
        extract: {
          itemSelector: ['.portfolio-item', '.portfolio-card'],
          linkSelector: ['a[href*="/portfolio/"]', 'a[href]'],
          titleSelector: ['.company-name', 'h2'],
          ...
          companyNameSelector: ['.company-name', 'h2'],
          companyWebsiteSelector: [
            'a[href*="http"]:not([href*="operatorscope.vc"])',
            '.company-site a[href]',
          ],
          includePatterns: ['/portfolio/'],
          excludeSelectors: ['.footer-cta', '.cta-banner'],
    ...
    expect(results).toHaveLength(1);
    expect(results[0].title).toBe('ScopeOps');
    expect(results[0].content).toBe('US startup helping finance, support, and GTM teams monitor routing, approvals, and launches with stronger operational scope. | Operator intelligence software for workflow analytics, execution monitoring, and operating visibility.');
    expect(results[0].company_name).toBe('ScopeOps');
    expect(results[0].company_website).toBe('https://scopeops.io/');
  ...
  test('HtmlListAdapter extracts Operator Orbit-style portfolio entries', async () => {
    global.fetch = jest.fn().mockResolvedValue({
      ok: true,
      text: async () => `
        <html>
          <body>
            <div class="portfolio-item">
              <a class="internal-link" href="/portfolio/orbitops">View</a>
              <div class="company-name">OrbitOps</div>
              <div class="description">Operator workflow software for execution visibility, process analytics, and approval orchestration.</div>
              <div class="subtext">US startup helping finance, support, and GTM teams monitor routing, approvals, and launches with stronger operator orbit systems.</div>
              <div class="company-site"><a href="https://orbitops.io/">Website</a></div>
            </div>
            <div class="footer-cta">
              <a href="/portfolio/footer-link">Ignore</a>
            </div>
    ...
    const adapter = new HtmlListAdapter({
      method: {
        url: 'https://operatororbit.vc/portfolio',
        extract: {
          itemSelector: ['.portfolio-item', '.portfolio-card'],
          linkSelector: ['a[href*="/portfolio/"]', 'a[href]'],
          titleSelector: ['.company-name', 'h2'],
          ...
          companyNameSelector: ['.company-name', 'h2'],
          companyWebsiteSelector: [
            'a[href*="http"]:not([href*="operatororbit.vc"])',
            '.company-site a[href]',
          ],
          includePatterns: ['/portfolio/'],
          excludeSelectors: ['.footer-cta', '.cta-banner'],
    ...
    expect(results).toHaveLength(1);
    expect(results[0].title).toBe('OrbitOps');
    expect(results[0].content).toBe('US startup helping finance, support, and GTM teams monitor routing, approvals, and launches with stronger operator orbit systems. | Operator workflow software for execution visibility, process analytics, and approval orchestration.');
    expect(results[0].company_name).toBe('OrbitOps');
    expect(results[0].company_website).toBe('https://orbitops.io/');
    expect(results[0].url).toBe('https://operatororbit.vc/portfolio/orbitops');
  });

  test('HtmlListAdapter extracts Operator Control Plane-style portfolio entries', async () => {
    global.fetch = jest.fn().mockResolvedValue({
      ok: true,
      text: async () => `
        <html>
          <body>
            <div class="portfolio-item">
              ...
              <div class="description">Operator control-plane software for workflow orchestration, execution visibility, and approval analytics.</div>
              <div class="subtext">US startup helping finance, support, and GTM teams monitor routing, approvals, and launches with stronger control-plane systems.</div>
    ...
    const adapter = new HtmlListAdapter({
      method: {
        url: 'https://operatorcontrolplane.vc/portfolio',
        extract: {
          itemSelector: ['.portfolio-item', '.portfolio-card'],
          linkSelector: ['a[href*="/portfolio/"]', 'a[href]'],
          titleSelector: ['.company-name', 'h2'],
          ...
          companyNameSelector: ['.company-name', 'h2'],
          companyWebsiteSelector: [
            'a[href*="http"]:not([href*="operatorcontrolplane.vc"])',
            '.company-site a[href]',
          ],
          includePatterns: ['/portfolio/'],
          excludeSelectors: ['.footer-cta', '.cta-banner'],
    ...
    expect(results[0].content).toBe('US startup helping finance, support, and GTM teams monitor routing, approvals, and launches with stronger control-plane systems. | Operator control-plane software for workflow orchestration, execution visibility, and approval analytics.');
    expect(results[0].company_name).toBe('ControlOps');
    expect(results[0].company_website).toBe('https://controlops.io/');
    expect(results[0].url).toBe('https://operatorcontrolplane.vc/portfolio/controlops');
  });

  test('HtmlListAdapter extracts Operator Command-style portfolio entries', async () => {
    global.fetch = jest.fn().mockResolvedValue({
      ok: true,
      text: async () => `
        <html>
          <body>
            <div class="portfolio-item">
              <a class="internal-link" href="/portfolio/commandops">View</a>
              <div class="company-name">CommandOps</div>
              <div class="description">Operator command software for workflow execution, orchestration visibility, and approval control.</div>
              <div class="subtext">US startup helping finance, support, and GTM teams monitor routing, approvals, and launches with stronger operator command systems.</div>
              <div class="company-site"><a href="https://commandops.io/">Website</a></div>
            </div>
            <div class="footer-cta">
              <a href="/portfolio/footer-link">Ignore</a>
            </div>
    ...
    const adapter = new HtmlListAdapter({
      method: {
        url: 'https://operatorcommand.vc/portfolio',
        extract: {
          itemSelector: ['.portfolio-item', '.portfolio-card'],
          linkSelector: ['a[href*="/portfolio/"]', 'a[href]'],
          titleSelector: ['.company-name', 'h2'],
          ...
          companyNameSelector: ['.company-name', 'h2'],
          companyWebsiteSelector: [
            'a[href*="http"]:not([href*="operatorcommand.vc"])',
            '.company-site a[href]',
          ],
          includePatterns: ['/portfolio/'],
          excludeSelectors: ['.footer-cta', '.cta-banner'],
    ...
    expect(results).toHaveLength(1);
    expect(results[0].title).toBe('CommandOps');
    expect(results[0].content).toBe('US startup helping finance, support, and GTM teams monitor routing, approvals, and launches with stronger operator command systems. | Operator command software for workflow execution, orchestration visibility, and approval control.');
    expect(results[0].company_name).toBe('CommandOps');
    expect(results[0].company_website).toBe('https://commandops.io/');
...
test('HtmlListAdapter extracts Operator Runbook-style portfolio entries', async () => {
  global.fetch = async () => ({
    ok: true,
    status: 200,
    headers: {
    ...
    text: async () => `
      <html>
        <body>
          <section class="portfolio-item">
            <a href="/portfolio/runbookops">View</a>
            <div class="company-name">RunbookOps</div>
            <div class="description">Runbook automation platform for operator teams managing execution, approvals, and workflow visibility.</div>
            <div class="subtext">US startup helping support, finance, and GTM teams automate runbooks, approvals, and operational handoffs.</div>
            <div class="company-site"><a href="https://runbookops.io/">Company</a></div>
          </section>
          <div class="footer-cta">Ignore this footer</div>
        </body>
      </html>
  ...
  const adapter = new HtmlListAdapter({
    method: {
      url: 'https://operatorrunbook.vc/portfolio',
      extract: {
        itemSelector: ['.portfolio-item', '.portfolio-card'],
        linkSelector: ['a[href*="/portfolio/"]', 'a[href]'],
        titleSelector: ['.company-name', 'h2'],
        ...
        companyNameSelector: ['.company-name', 'h2'],
        companyWebsiteSelector: [
          'a[href*="http"]:not([href*="operatorrunbook.vc"])',
          '.company-site a[href]',
        ],
        includePatterns: ['/portfolio/'],
        excludeSelectors: ['.footer-cta', '.cta-banner'],
  ...
  expect(results).toHaveLength(1);
  expect(results[0].title).toBe('RunbookOps');
  expect(results[0].content).toBe(
    'US startup helping support, finance, and GTM teams automate runbooks, approvals, and operational handoffs. | Runbook automation platform for operator teams managing execution, approvals, and workflow visibility.'
  );
  expect(results[0].company_name).toBe('RunbookOps');
  expect(results[0].company_website).toBe('https://runbookops.io/');
...
test('HtmlListAdapter extracts Operator Canvas-style portfolio entries', async () => {
  global.fetch = async () => ({
    ok: true,
    status: 200,
    headers: {
    ...
    text: async () => `
      <html>
        <body>
          <section class="portfolio-item">
            <a href="/portfolio/canvasops">View</a>
            <div class="company-name">CanvasOps</div>
            <div class="description">Operational workflow platform for routing, approvals, and execution handoffs.</div>
            <div class="subtext">US startup helping support, finance, and GTM teams coordinate operator workflows, process automation, and execution visibility.</div>
            <div class="company-site"><a href="https://canvasops.io/">Company</a></div>
          </section>
          <div class="footer-cta">Ignore this footer</div>
        </body>
      </html>
  ...
  const adapter = new HtmlListAdapter({
    method: {
      url: 'https://operatorcanvas.vc/portfolio',
      extract: {
        itemSelector: ['.portfolio-item', '.portfolio-card'],
        linkSelector: ['a[href*="/portfolio/"]', 'a[href]'],
        titleSelector: ['.company-name', 'h2'],
        ...
        companyNameSelector: ['.company-name', 'h2'],
        companyWebsiteSelector: [
          'a[href*="http"]:not([href*="operatorcanvas.vc"])',
          '.company-site a[href]',
        ],
        includePatterns: ['/portfolio/'],
        excludeSelectors: ['.footer-cta', '.cta-banner'],
  ...
  expect(results).toHaveLength(1);
  expect(results[0].title).toBe('CanvasOps');
  expect(results[0].content).toBe(
    'US startup helping support, finance, and GTM teams coordinate operator workflows, process automation, and execution visibility. | Operational workflow platform for routing, approvals, and execution handoffs.'
  );
  expect(results[0].company_name).toBe('CanvasOps');
  expect(results[0].company_website).toBe('https://canvasops.io/');
